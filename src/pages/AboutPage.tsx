...
export const AboutPage: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in space-y-20 pb-20">
      ...
      {/* Hero Section — WARM IVORY PALETTE */}
      <section className="bg-ivory-200 text-navy-950 py-20 border-b border-ivory-300">
        <div className="max-w-5xl mx-auto px-4 text-center space-y-6">
          <img src={LOGO_URL} alt="Richbecky Gallery" className="h-16 w-auto mx-auto object-contain mb-4" />
          <span className="text-gold-700 text-xs uppercase tracking-widest font-bold block">Curatorial Vision</span>
          <h1 className="font-serif text-3xl sm:text-5xl font-bold leading-tight text-navy-950">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
          <span className="text-xs font-bold text-gold-700 uppercase tracking-widest">Our Promise</span>
          <h2 className="font-serif text-3xl font-bold text-navy-950">Museum-Grade Standards</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl border border-ivory-300 shadow-subtle space-y-4 text-center">
            ...
            <h3 className="font-serif text-xl font-bold text-navy-950">Authenticated Lineage</h3>
          ...
          <div className="bg-white p-8 rounded-xl border border-ivory-300 shadow-subtle space-y-4 text-center">
            ...
            <h3 className="font-serif text-xl font-bold text-navy-950">White-Glove Logistics</h3>
            <p className="text-xs text-neutral-600 leading-relaxed font-light">
          ...
          <div className="bg-white p-8 rounded-xl border border-ivory-300 shadow-subtle space-y-4 text-center">
            ...
            <h3 className="font-serif text-xl font-bold text-navy-950">Artist Empowerment</h3>
            <p className="text-xs text-neutral-600 leading-relaxed font-light">
      ...
      <section className="bg-ivory-200 border-y border-ivory-300 py-16 text-center">
        <div className="max-w-3xl mx-auto px-4 space-y-6">
          <h2 className="font-serif text-3xl font-bold text-navy-950">Begin Your Fine Art Collection</h2>
          ...
          <div className="pt-2">
            <button
              ...
              className="px-8 py-3.5 bg-gold-500 hover:bg-gold-400 text-navy-950 rounded-sm font-bold text-xs uppercase tracking-widest transition shadow-md inline-flex items-center gap-2"
            >
