...
export const CustomerLoginPage: React.FC = () => {
  const { loginCustomer, loginDirectly, setActivePage, showToast } = useGallery();
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12 animate-fade-in">
      <div className="max-w-md w-full bg-white p-8 sm:p-10 rounded-2xl border border-ivory-300 shadow-gallery space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-xs">
          ...
          <button
            type="button"
            onClick={() => loginDirectly('customer', email || 'collector@richbeckygallery.com', 'Rebecca Vanguard')}
